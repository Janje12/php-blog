<nav class="navbar navbar-expand-lg navbar-light bg-light">
  <div class="container-fluid">
    <a class="navbar-brand" href="#">AjTi Blog</a>
    ...
    <div class="collapse navbar-collapse" id="navbarSupportedContent">
      <ul class="navbar-nav me-auto mb-2 mb-lg-0">
        ...
        <li class="nav-item">
          <a class="nav-link" href="#">Top objave</a>
        </li>
        <li class="nav-item">
          <a class="nav-link" href="#">Sve objave</a>
        </li>
      </ul>
      <form class="d-flex mx-2">
        <input class="form-control" type="search" placeholder="Pretraži" aria-label="Search">
